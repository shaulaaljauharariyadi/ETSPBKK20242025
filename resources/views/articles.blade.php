<x-layout>
  ...
  @foreach ($articles as $article)
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($article->body, 100) }}</p>
              <div class="flex justify-between items-center">
                <a href="/authors/{{ $article->author->id }}" class="hover:underline">
                  <div class="flex items-center space-x-4">
                      <img class="w-7 h-7 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="{{ $article->author->name }}" />
                  ...
                  <a href="articles/{{ $article['slug'] }}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                      Read more
